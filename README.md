...
The home page banner now rotates through six images every 6.5 seconds, with previous/next buttons. It pauses when the page is hidden or the banner is out of view; reduced-motion users can change images manually. The home page loads `styles.css?v=9` and `app.js?v=8`.
